...
// manage URL: https://paystack.com/manage-subscription/{emailToken}
...
router.get('/billing-portal', requireAuth, billingLimiter, async (req: Request, res: Response) => {
  try {
    ...
    // FIX: Paystack manage-subscription URL uses the email_token.
    ...
    if (sub?.paystackEmailToken) {
      return res.json({
        success: true,
        url:     `https://paystack.com/manage-subscription/${sub.paystackEmailToken}`,
