...
// ─── GET /api/v1/progress/achievements/recalculate ───────────────────────────
// Evaluates all achievements for the current user based on their workout history.
// Called once per session from frontend to handle historical workouts.
router.get('/achievements/recalculate', async (req: Request, res: Response) => {
  try {
