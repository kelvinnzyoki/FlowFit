...
// CORS — credentials:true requires an explicit origin list, never '*'.
// CORS_ORIGIN env var can be a single URL or comma-separated list.
// Always includes both the API domain and the GitHub Pages frontend.
const allowedOrigins = [
  'https://flowfit.cctamcc.site',   // GitHub Pages frontend
  'https://fit.cctamcc.site',        // API domain (Vercel)
