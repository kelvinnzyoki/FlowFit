...
export async function createCheckoutSession(
  ...
  try {
    txn = await initializeTransaction({
      ...
      currency: 'KES',
      // IMPORTANT: Do NOT pass `plan` here. We first collect the card payment,
      // then create the Paystack subscription during verification using the
      // transaction's reusable authorization_code and a future start_date. This
      // avoids Paystack's async subscription.create race and prevents duplicate
