...
User message: ${message}`;
  ...
  // Typed explicitly — strict TS narrows res.json() to {} via unknown,
  // making .message inaccessible. Asserting the Ollama chat shape fixes TS2339.
  ...
  // Typed explicitly — same strict-TS narrowing issue as the chat call above.
  // Ollama embed response shape: { embedding: number[] }
